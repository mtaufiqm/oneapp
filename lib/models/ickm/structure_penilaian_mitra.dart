...
class StructurePenilaianMitraDetailsWithNotes {
  String? uuid;
  String kuesioner_penilaian_mitra_uuid;
  String kuesioner_penilaian_mitra_title;
  String kuesioner_penilaian_mitra_start_date;
  ...
  StructurePenilaianMitraDetailsWithNotes({
    this.uuid,
    required this.kuesioner_penilaian_mitra_uuid,
    required this.kuesioner_penilaian_mitra_title,
    required this.kuesioner_penilaian_mitra_start_date,
  ...
  StructurePenilaianMitraDetailsWithNotes copyWith({
    String? uuid,
    String? kuesioner_penilaian_mitra_uuid,
    String? kuesioner_penilaian_mitra_title,
    String? kuesioner_penilaian_mitra_start_date,
    ...
    return StructurePenilaianMitraDetailsWithNotes(
      uuid: uuid ?? this.uuid,
      kuesioner_penilaian_mitra_uuid: kuesioner_penilaian_mitra_uuid ?? this.kuesioner_penilaian_mitra_uuid,
      kuesioner_penilaian_mitra_title: kuesioner_penilaian_mitra_title ?? this.kuesioner_penilaian_mitra_title,
      kuesioner_penilaian_mitra_start_date: kuesioner_penilaian_mitra_start_date ?? this.kuesioner_penilaian_mitra_start_date,
      ...
      response_is_completed: response_is_completed ?? this.response_is_completed,
      response_updated_at: response_updated_at ?? this.response_updated_at,
      response_notes: response_notes ?? this.response_notes,
    );
  }
  ...
  factory StructurePenilaianMitraDetailsWithNotes.fromJson(Map<String, dynamic> map) {
    return StructurePenilaianMitraDetailsWithNotes(
      uuid: map['uuid'] != null ? map['uuid'] as String : null,
      kuesioner_penilaian_mitra_uuid: map['kuesioner_penilaian_mitra_uuid'] as String,
      kuesioner_penilaian_mitra_title: map['kuesioner_penilaian_mitra_title'] as String,
      ...
      response_is_completed: map['response_is_completed'] != null ? map['response_is_completed'] as bool : null,
      response_updated_at: map['response_updated_at'] != null ? map['response_updated_at'] as String : null,
      response_notes: map['response_notes'] != null ? map['response_notes'] as String : null,
    );
  }

    factory StructurePenilaianMitraDetailsWithNotes.fromDb(Map<String, dynamic> map) {
    return StructurePenilaianMitraDetailsWithNotes(
      uuid: map['uuid'] != null ? map['uuid'] as String : null,
      kuesioner_penilaian_mitra_uuid: map['kuesioner_penilaian_mitra_uuid'] as String,
      kuesioner_penilaian_mitra_title: map['kuesioner_penilaian_mitra_title'] as String,
  ...
  @override
  String toString() {
    return 'StructurePenilaianMitraDetailsWithNotes(uuid: $uuid, kuesioner_penilaian_mitra_uuid: $kuesioner_penilaian_mitra_uuid, kuesioner_penilaian_mitra_title: $kuesioner_penilaian_mitra_title, kuesioner_penilaian_mitra_start_date: $kuesioner_penilaian_mitra_start_date, kuesioner_penilaian_mitra_end_date: $kuesioner_penilaian_mitra_end_date, kegiatan_uuid: $kegiatan_uuid, kegiatan_name: $kegiatan_name, penilai_username: $penilai_username, penilai_fullname: $penilai_fullname, mitra_username: $mitra_username, mitra_id: $mitra_id, mitra_fullname: $mitra_fullname, survei_uuid: $survei_uuid, survei_name: $survei_name, survei_type: $survei_type, isHaveResponse: $isHaveResponse, response_uuid: $response_uuid, response_is_completed: $response_is_completed, response_updated_at: $response_updated_at, response_notes: $response_notes)';
  }

  @override
  bool operator ==(covariant StructurePenilaianMitraDetailsWithNotes other) {
    if (identical(this, other)) return true;
    ...
    return 
      ...
      other.response_is_completed == response_is_completed &&
      other.response_updated_at == response_updated_at &&
      other.response_notes == response_notes;
  }

  @override
  int get hashCode {
    return uuid.hashCode ^
      kuesioner_penilaian_mitra_uuid.hashCode ^
      kuesioner_penilaian_mitra_title.hashCode ^
      kuesioner_penilaian_mitra_start_date.hashCode ^
      kuesioner_penilaian_mitra_end_date.hashCode ^
      kegiatan_uuid.hashCode ^
      kegiatan_name.hashCode ^
      penilai_username.hashCode ^
      penilai_fullname.hashCode ^
      mitra_username.hashCode ^
      mitra_id.hashCode ^
      mitra_fullname.hashCode ^
      survei_uuid.hashCode ^
      survei_name.hashCode ^
      survei_type.hashCode ^
      isHaveResponse.hashCode ^
      response_uuid.hashCode ^
      response_is_completed.hashCode ^
      response_updated_at.hashCode ^
      response_notes.hashCode;
  }
}
